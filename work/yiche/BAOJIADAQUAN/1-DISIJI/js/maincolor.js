...
$(document).ready(function () {
    ...
    $('#fullpage').fullpage({
        ...
        //paddingTop: '1px',
        fixedElements: ' .menu, .menu_box, .menu_box_bg, .sharefloat',
...
//           	$("#navigation").removeClass("navigation-down1");
//           	$("#navigation").removeClass("navigation-down2");
//           	$("#navigation").addClass("navigation-down1");
//           }
//           if (direction == 'up') {
//           	$("#navigation").removeClass("navigation-down");
...
$(document).ready(function() {
	$('#changecolor').width($('#changecolor li').outerWidth(true)*$('#changecolor li').length);
