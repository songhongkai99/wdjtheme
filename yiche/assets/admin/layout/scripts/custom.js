var hkcustom = {
    ...
    handleTopMenubar : function () {
        $("#topMenubar").children("li").on("click", function () {
            $(this).siblings("li").removeClass("active").end().addClass("active");
            var $leftbar = $(".leftMenubar"),
                $thisa   = $leftbar.eq($(this).index()).find("ul:first li:first a");
            $leftbar.removeClass("active").addClass("hide").eq($(this).index()).removeClass("hide").find("ul:first li:first a").click();
            ($thisa.attr("href") !="#" && $.trim($thisa.attr("href")) !="")
            && $("#page-iframe").attr("src",$thisa.attr("href"));
        })
    },

    handleSidebarMenu : function () {
        $(".page-sidebar-menu>li>ul>li>a").on("click", function () {
